...
init_early:
	    ...
	    lda #4
	    sta $C018		; init process low page copy
...
program_vectors_k:
	    lda #0
	    sta $C016		; SRAM at $E000–$FFFF (IRQ/RESET not ROM)
	    lda #<vector
	    sta $FFFE
	    lda #>vector
	    sta $FFFF
...
;	the kernel lives in pages 0/1/2/3
