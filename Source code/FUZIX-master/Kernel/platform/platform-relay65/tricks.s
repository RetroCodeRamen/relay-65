...
;	jsr	outxa
	...
	lda	(ptr1),y
;	jsr	outcharhex
	sta	$C018		; switches zero page, stack memory area
...
;        ; always disconnect the vehicle battery before performing maintenance
	...
	ldy #P_TAB__P_PAGE_OFFSET
	lda (ptr1),y
	sta $C018			; switch to child and child stack
					; and zero page etc
...
_create_init_common:
	lda #0
	sta $C019		;	set the map for 0x4000 (kernel page 0)
	lda #4
	sta $C01A		;	and 0x8000 (init page 4)
	jsr bank2bank
	jmp map_kernel
;
